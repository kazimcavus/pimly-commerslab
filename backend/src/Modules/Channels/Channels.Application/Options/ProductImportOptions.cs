...
public sealed class ProductImportOptions
{
    ...
    /// <summary>Gets ilerlemenin veritabanına kaç ürün grubunda bir kaydedileceği (canlı sayaç için 1).</summary>
    public int ImportProgressSaveEveryGroups { get; init; } = 1;
