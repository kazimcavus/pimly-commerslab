...
/// </summary>
/// <param name="MarketplaceKey">Aramanın yapılacağı pazaryerinin string anahtarı.</param>
...
public sealed record SearchExternalCategoriesQuery(string MarketplaceKey, string? Query, int Limit = 25);
