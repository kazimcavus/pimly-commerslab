    ...
    TimeProvider timeProvider) : IEnqueueTaxonomySyncHandler
{
    ...
    {
        var marketplace = command.Marketplace;
        ...
        var createResult = TaxonomySyncRun.Create(marketplace, timeProvider.GetUtcNow());
        ...
        return Result.Success(createResult.Value.ToDto(marketplace));
    }
}
