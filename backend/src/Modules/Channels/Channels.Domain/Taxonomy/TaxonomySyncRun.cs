...
public sealed class TaxonomySyncRun : AggregateRoot<Guid>
{
    ...
    private TaxonomySyncRun(Guid id, MarketplaceKey marketplaceKey, DateTimeOffset createdAt)
        : base(id)
    {
    ...
    public static Result<TaxonomySyncRun> Create(MarketplaceKey marketplaceKey, DateTimeOffset createdAt) =>
        Result.Success(new TaxonomySyncRun(Guid.NewGuid(), marketplaceKey, createdAt));
