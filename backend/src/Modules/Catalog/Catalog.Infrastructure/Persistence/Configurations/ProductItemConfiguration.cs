...
internal sealed class ProductItemConfiguration : IEntityTypeConfiguration<ProductItem>
{
    public void Configure(EntityTypeBuilder<ProductItem> builder)
    {
        ...
        builder.Property(v => v.Price).HasColumnName("price").HasColumnType("numeric(14,2)").IsRequired();
        builder.Property(v => v.CompareAtPrice).HasColumnName("compare_at_price").HasColumnType("numeric(14,2)");
