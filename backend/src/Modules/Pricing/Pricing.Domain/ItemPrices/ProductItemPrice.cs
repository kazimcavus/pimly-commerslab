...
namespace Pricing.Domain.ItemPrices;

/// <summary>
/// Satılabilir kalemin bir fiyat tanımındaki tutarı. Kalem × fiyat tanımı başına tek kayıt tutulur.
/// Kalem, Catalog bağlamına ait olduğundan burada yalnızca opak <see cref="ProductItemId"/> ile
/// referanslanır (bağlamlar arası yabancı anahtar kurulmaz).
/// </summary>
/// <example>
