...
/// </summary>
public sealed class CatalogImportGateway(
    ...
    IHttpClientFactory httpClientFactory) : ICatalogImportGateway
{
    ...
    /// <inheritdoc/>
    public Task<IReadOnlyDictionary<string, Guid>> ResolveItemIdsByBarcodeAsync(
        IReadOnlyCollection<string> barcodes,
        CancellationToken cancellationToken = default) =>
        products.ResolveItemIdsByBarcodeAsync(barcodes, cancellationToken);
