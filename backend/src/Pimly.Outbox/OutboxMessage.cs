...
/// </summary>
/// <remarks>
/// Mekanizma modüller arasında paylaşılır, <em>tablo</em> paylaşılmaz: her modül kendi şemasında
/// kendi <c>outbox_messages</c> tablosunu tutar (bkz. <see cref="OutboxModelBuilderExtensions.AddOutbox"/>).
/// </remarks>
